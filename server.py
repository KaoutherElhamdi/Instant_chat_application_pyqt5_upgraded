...
class Server(object):
    ...
    k=-1
    pictureclient = "profile.jpg"
    usernameclient = "Username"
    
    def setupUi(self, MainWindow,pictureclient,usernameclient):
        Server.pictureclient = pictureclient
        Server.usernameclient = usernameclient
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(Server.pictureclient), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.UsernameBtn.setText(_translate("MainWindow", Server.usernameclient))
    ...
    def send(self):
        ...
        msg_to_send = afficher_message("You"+"_"*(len(Server.usernameclient)-2)+": ",msg_to_send)
        msg_to_send = msg_to_send+"\n"
        Server.k+= 1
        self.listWidget.addItem(msg_to_send)
        self.listWidget.item(Server.k).setBackground(QtCore.Qt.lightGray)
    ...
    def receive(self):
        while True:
            ...
            if len(msg_received ) != 0 :
                Server.k+=1
            self.listWidget.addItem(afficher_message(Server.usernameclient+" : ",msg_received)+"\n")
            self.listWidget.item(Server.k).setBackground(QtGui.QColor(89, 164, 184))
...
class window_1(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Server"))
    ...
    def setProfilePicture(self):
        ...
        with open("name_pic_server","w") as f :
            f.write(fileName+'\n'+window_1.name+"\n")
    ...
    def setUserName(self):
        ...
        with open("name_pic_server","r") as f :
            msg = f.readlines()
            msg = "".join(msg)
        ...
        msg = msg.split("\n")
        pictureclient = msg[0]   #Retrieve the link of the profile picture ****
        usernameclient = msg[1]  #Retrieve the username of the client

                        
        self.window = QtWidgets.QMainWindow()
        self.ui = Server()
        self.ui.setupUi(self.window,pictureclient,usernameclient)
        MainWindow.hide()
        self.window.show()
